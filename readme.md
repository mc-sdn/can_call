...
<img src="https://img.shields.io/badge/keywords-Clang,%20AST,%20Python bindings to libclang,%20clang.cindex-cyan.svg" alt="keywords">
...
Clang has also a built-in AST-dump mode; below, the `some_file.c` converted into an AST.
